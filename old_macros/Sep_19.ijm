...
close("Macrophage");
//Re-merging to prep for ROI selection
run("Merge Channels..." , "c2=[Denoised-Asyn] c6=[Denoised-TUJ1] c7=[Denoised-Macrophage] create"); 
rename("Merge_1");
selectWindow("Merge_1");
run("Duplicate...", "title=Composite duplicate");
//selectWindow("Merge_1");
//run("Subtract Background...", "rolling=10 stack");

//First ROI manager prompts 
run("ROI Manager...");
waitForUser("Select the TUJ1 channel. Hit OK when complete"); 
