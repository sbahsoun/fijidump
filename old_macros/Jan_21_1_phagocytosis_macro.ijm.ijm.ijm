...
//put in macro to detect all ROIS
//for all that have measurmeent > 1, then contonie with macro
//else should be ROI int density of 0 
//what is the measurement 
//go into actual paper and find the original protocol to do it 
