...
//open image
//crop immediately
//only background subtract the asyn channel
//then de noise each small one
//threshold each small channel and 
//then fill in holes in TUJ1 
///remerge don't need unfilled area 
